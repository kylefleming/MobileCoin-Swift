...
enum Slip10Utils {
            ...
            spendPrivateKeyOut.asMcMutableBuffer { spendPrivateKeyOutPtr in
                ...
                case .failure(let error):
                    ...
                    case .invalidInput:
                        ...
                        logger.fatalError("LibMobileCoin invalidInput error: \(error.description)")
                    default:
                        // Safety: mc_slip10_account_private_keys_from_mnemonic should not throw
                        // non-documented errors.
                        logger.fatalError("Unhandled LibMobileCoin error: \(error)")
                    }
                }
            }
        }
                  ...
                  InvalidInputError>
    {
        ...
        return viewPrivateKeyOut.asMcMutableBuffer { viewPrivateKeyOutPtr in
            spendPrivateKeyOut.asMcMutableBuffer { spendPrivateKeyOutPtr in
                return withMcError { errorPtr in
                    mc_slip10_account_private_keys_from_mnemonic(
                        mnemonic,
                        accountIndex,
                        viewPrivateKeyOutPtr,
                    ...
                    default:
                        // Safety: mc_slip10_account_private_keys_from_mnemonic should not throw
                        // non-documented errors.
                        logger.fatalError("Unhandled LibMobileCoin error: \($0)")
                    }
                }
            }
        }.map {
